...
- [x] **TASK-017. Phase 4 全书校验**（完成于 2026-05-24，PR #12 已合并，fix #17）
...
- [x] **TASK-018. 在线阅读器**（完成于 2026-05-24，PR #13 已合并，fix #18）
...
- [x] **TASK-019. 章节编辑器（M8）**（完成于 2026-05-24，PR #14 已合并，fix #19）
...
- [x] **TASK-020. 一致性检查与 AI 润色**（完成于 2026-05-24，PR #21 已合并）
...
- [x] **TASK-022. 用户 LLM 配置**（完成于 2026-05-24，PR #23 已合并）
...
- [x] **TASK-023. 知识库管理**（完成于 2026-05-24，PR #24 已合并）
